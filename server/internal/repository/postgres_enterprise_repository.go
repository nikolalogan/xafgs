...
SET
  ...
  established_at = $12,
  non_standard_financing_ratio = $13,
  main_business = $14,
  related_party_public_opinion = $15,
  admission_status = $16,
  calculated_at = $17,
  registered_capital = $18,
  paid_in_capital = $19,
  industry = $20,
  address = $21,
  business_scope = $22,
  legal_person = $23,
  company_type = $24,
  enterprise_nature = $25,
  actual_controller = $26,
  actual_controller_control_path = $27,
  issuer_rating = $28,
  issuer_rating_agency = $29,
...
INSERT INTO enterprise_finance_snapshot (
  enterprise_id, liability_asset_ratio, roa, roa_industry_median, roa_industry_1_4, roa_industry_3_4, roe, roe_industry_1_4, roe_industry_3_4, interest_coverage,
  ebit_coverage, ebit_coverage_industry_median, ebit_coverage_industry_1_4, ebit_coverage_industry_3_4,
  ebitda_coverage, ebitda_coverage_industry_median, ebitda_coverage_industry_1_4, ebitda_coverage_industry_3_4,
  liability_asset_ratio_industry_median, liability_asset_ratio_industry_1_4, liability_asset_ratio_industry_3_4,
  roe_industry_median, non_standard_financing_ratio_industry_median,
...
`,
			...
			item.LiabilityAssetRatio,
			item.ROA,
			item.ROAIndustryMedian,
			item.ROAIndustry1_4,
			item.ROAIndustry3_4,
			item.ROE,
			item.ROEIndustry1_4,
			...
			item.EBITCoverageIndustry1_4,
			item.EBITCoverageIndustry3_4,
			item.EBITDACoverage,
			item.EBITDACoverageIndustryMedian,
			item.EBITDACoverageIndustry1_4,
			item.EBITDACoverageIndustry3_4,
			item.LiabilityAssetRatioIndustryMedian,
			item.LiabilityAssetRatioIndustry1_4,
			item.LiabilityAssetRatioIndustry3_4,
...
`, enterpriseID)
	...
	err = queryRow(`
SELECT id, liability_asset_ratio, roa, roa_industry_median, roa_industry_1_4, roa_industry_3_4, roe, roe_industry_1_4, roe_industry_3_4, interest_coverage,
  ebit_coverage, ebit_coverage_industry_median, ebit_coverage_industry_1_4, ebit_coverage_industry_3_4,
  ebitda_coverage, ebitda_coverage_industry_median, ebitda_coverage_industry_1_4, ebitda_coverage_industry_3_4,
  liability_asset_ratio_industry_median, liability_asset_ratio_industry_1_4, liability_asset_ratio_industry_3_4,
  roe_industry_median, non_standard_financing_ratio_industry_median,
...
`, enterpriseID).Scan(
		&snapshot.ID,
		floatPtrScanner{dst: &snapshot.LiabilityAssetRatio},
		floatPtrScanner{dst: &snapshot.ROA},
		floatPtrScanner{dst: &snapshot.ROAIndustryMedian},
		floatPtrScanner{dst: &snapshot.ROAIndustry1_4},
		floatPtrScanner{dst: &snapshot.ROAIndustry3_4},
		floatPtrScanner{dst: &snapshot.ROE},
		floatPtrScanner{dst: &snapshot.ROEIndustry1_4},
		floatPtrScanner{dst: &snapshot.ROEIndustry3_4},
		...
		floatPtrScanner{dst: &snapshot.EBITCoverageIndustry1_4},
		floatPtrScanner{dst: &snapshot.EBITCoverageIndustry3_4},
		floatPtrScanner{dst: &snapshot.EBITDACoverage},
		floatPtrScanner{dst: &snapshot.EBITDACoverageIndustryMedian},
		floatPtrScanner{dst: &snapshot.EBITDACoverageIndustry1_4},
		floatPtrScanner{dst: &snapshot.EBITDACoverageIndustry3_4},
		floatPtrScanner{dst: &snapshot.LiabilityAssetRatioIndustryMedian},
		floatPtrScanner{dst: &snapshot.LiabilityAssetRatioIndustry1_4},
		floatPtrScanner{dst: &snapshot.LiabilityAssetRatioIndustry3_4},
