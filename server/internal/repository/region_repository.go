...
type RegionRepository interface {
	...
	Create(region model.Region, economies []model.RegionEconomy) model.RegionDetailDTO
	Update(regionID int64, region model.Region, economies []model.RegionEconomy) (model.RegionDetailDTO, bool)
...
func (repository *regionRepository) Create(region model.Region, economies []model.RegionEconomy) model.RegionDetailDTO {
	now := time.Now().UTC()
...
func (repository *regionRepository) Update(regionID int64, region model.Region, economies []model.RegionEconomy) (model.RegionDetailDTO, bool) {
