...
export type ToolbarActionKey = 'undo' | 'redo' | 'layout' | 'save' | 'run' | 'globalParams' | 'check' | 'export' | 'import' | 'reset' | 'aiNodeGenerate'
...
export const toolbarActionButtons: Array<{ key: ToolbarActionKey; label: string; className: string }> = [
  ...
  { key: 'save', label: '保存', className: 'rounded bg-blue-700 px-3 py-1.5 text-xs text-white hover:bg-blue-800' },
